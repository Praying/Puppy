...
#ifndef SERVER_CHTTPCONN_HPP
#define SERVER_CHTTPCONN_HPP
...
namespace Flow{
    using Flow::Network::CSimpleBuffer;
    using Flow::Util::CRefObject;
    using Flow::Network::CHttpParserWrapper;
