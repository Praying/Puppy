...
#ifndef SERVER_FILESERVERUTIL_HPP
#define SERVER_FILESERVERUTIL_HPP
   ...
   // using namespace Network;
    typedef struct file_header_t
    {
        ...
        void set_from_user_id(uint32_t id) {
            strcpy(from_user_id, Network::idtourl(id));
        } // warn! Util::idtourl
        ...
        void set_to_user_id(uint32_t id) {
            strcpy(to_user_id, Network::idtourl(id));
        }
...
#endif //SERVER_FILESERVERUTIL_HPP
