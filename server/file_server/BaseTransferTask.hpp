...
// 状态机
    ...
    struct OfflineFileHeader {
        ...
        uint32_t get_from_user_id() const {
            return Util::string2int(std::string(from_user_id));
        }

        uint32_t get_to_user_id() const {
            return Util::string2int(std::string(to_user_id));
        }

        uint32_t get_create_time() const {
            return Util::string2int(std::string(create_time));
        }
        ...
        uint32_t get_file_size() const {
            return Util::string2int(std::string(file_size));
        }
