...
#ifndef SERVER_CTCPCLIENTASYNC_HPP
#define SERVER_CTCPCLIENTASYNC_HPP

#include <push_server/socket/SocketIO.hpp>
#include <cstdint>
...
#include <push_server/buffer_loop/buffer_loop.hpp>
...
namespace Flow::PushServer {
    ...
    protected:
        ...
        std::queue<CSimpleBuffer *> m_sendqueue;        //待发送队列，只有非阻塞的TCP socket才会用到
        CBaseMutex m_sendqueuemutex;
    };

}

#endif //SERVER_CTCPCLIENTASYNC_HPP
