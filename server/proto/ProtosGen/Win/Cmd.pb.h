...
const CommandType CommandType_MIN = COMMAND_TYPE_NULL;
const CommandType CommandType_MAX = COMMAND_TYPE_SERVER;
...
template <> struct is_proto_enum< ::CommandType> : ::google::protobuf::internal::true_type {};
template <>
