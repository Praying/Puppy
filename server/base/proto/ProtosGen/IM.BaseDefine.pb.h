...
const BuddyListCmdID BuddyListCmdID_MIN = CID_BUDDY_LIST_NONE;
...
const MessageCmdID MessageCmdID_MIN = CID_MSG_NONE;
...
const GroupCmdID GroupCmdID_MIN = CID_GROUP_NONE;
...
const FileCmdID FileCmdID_MIN = CID_FILE_NONE;
...
const SwitchServiceCmdID SwitchServiceCmdID_MIN = CID_SWITCH_NONE;
...
const OtherCmdID OtherCmdID_MIN = CID_OTHER_NONE;
...
const OnlineListType OnlineListType_MIN = ONLINE_LIST_NONE;
...
const ClientFileRole ClientFileRole_MIN = CLIENT_NONE;
