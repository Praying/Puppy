...
#ifndef SERVER_PUBLICDEFINE_HPP
#define SERVER_PUBLICDEFINE_HPP
...
bRet;\
    ...
    typedef struct {
        uint32_t user_id;
        std::set<uint32_t> allow_user_ids;
        std::set<uint32_t> allow_group_ids;
        std::set<std::string> authed_ips;
        std::set<std::string> authed_interfaces;
    } auth_struct;

#define MAX_MSG_LEN     4096
}

#endif //SERVER_PUBLICDEFINE_HPP
