...
#include "Login.hpp"
#include "CInterLoginStrategy.hpp"
...
namespace Flow::DB_PROXY {
    ...
    void doLogin(CImPdu *pPdu, uint32_t conn_uuid) {
        ...
        if (msg.ParseFromArray(pPdu->GetBodyData(), pPdu->GetBodyLength())) {
            ...
            std::string strDomain = msg.user_name();
            std::string strPass = msg.password();
            ...
            LOG(INFO) << strDomain << " request login.";
